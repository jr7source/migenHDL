...
reg [31:0] Tx_Event_FIFO_Status;
reg [31:0] Timestamp_1;
reg [31:0] Timestamp_2;
reg [2:0] fsm0 = 3'd0;
reg [2:0] fsm1;
...
always @(*) begin
	...
	case (fsm0)
		...
		3'd5: begin
			Tx_Event_FIFO_Status <= TXEFS;
			Timestamp_1 <= (6'd32 + (2'd2 * TXEFS[11:8]));
			Timestamp_2 <= ((6'd32 + (2'd2 * TXEFS[11:8])) + 1'd1);
			TXEFA <= TXEFS[11:8];
			fsm1 <= 1'd0;
		end
		default: begin
